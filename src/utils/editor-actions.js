...
(function(window) {
    ...
    const EditorActions = {
         ...
         */
        applySettingsToDOM() {
            // Apply to main app settings panel first
            const mainActionBarToggle = document.querySelector('input[name="actionBarVisible"]');
            if (mainActionBarToggle) {
                mainActionBarToggle.checked = Boolean(this.state.settings.actionBarVisible);
                console.log('Applied actionBarVisible to main settings:', this.state.settings.actionBarVisible);
            }
         ...
         * This is now disabled since we use the main settings panel
         */
        createMinimalSettings() {
            console.log('Using main settings panel instead of creating minimal settings');
            // Don't create minimal settings - use the main app settings panel
            return;
        },
        ...
        /**
         * Fallback: Create action bar in body (now just appends to body without fixed positioning)
         */
